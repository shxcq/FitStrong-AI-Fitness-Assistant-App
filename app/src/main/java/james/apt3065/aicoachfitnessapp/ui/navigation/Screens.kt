...
sealed class Screens(
    ...
    object Profile :
        Screens(route = "ChatPage", title = R.string.chatbot, icon = Icons.Rounded.SupportAgent)
    ...
    object ExerciseDetails : Screens(route = "exercises_details_screen", title = R.string.ai_trainer)
